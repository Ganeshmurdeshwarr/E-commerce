...
const products = [
  ...
  },
  {
    ...
    description:
      "A wardrobe classic, this polo t-shirt features a ribbed collar and cuffs. Made from 100% cotton, it offers breath ability and comfort throughout the day. Tailored in a slim fit with a button placket at the neckline.",
    price: 24.99,
    discountPrice: 19.99,
    countInStock: 50,
    sku: "POLO-TSH-006",
  ...
  },
  {
    ...
    description:
      "A modern take on the classic Henley shirt, this regular-fit style features a buttoned placket and ribbed cuffs. Made from a soft cotton blend with a touch of elastance for stretch.",
    price: 22.99,
    discountPrice: 18.99,
    countInStock: 35,
    sku: "REG-HEN-008",
  ...
  },
  {
    ...
    collections: "Lounge wear Collection",
    material: "Cotton Blend",
    gender: "Women",
    images: [
      {
  ...
  },
  {
    ...
    description:
      "Stylish paper bag waist shorts with a belted waist and wide legs. Perfect for summer outings and keeping cool in style.",
    price: 35,
    discountPrice: 30,
    countInStock: 20,
    sku: "BW-W-007",
    ...
    images: [
      {
        ...
        altText: "Paper bag Waist Shorts Front View",
      },
    ],
    rating: 4.5,
    numReviews: 19,
  ...
  },
  {
    ...
    description:
      "Timeless pleated trousers with a tailored fit. A wardrobe essential for work wear or formal occasions.",
    price: 70,
    discountPrice: 65,
    countInStock: 25,
    sku: "BW-W-010",
